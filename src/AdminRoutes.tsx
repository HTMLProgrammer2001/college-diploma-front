...
import WithErrorHandlers from './utils/HOC/WithErrorHandlers';
...
const AdminRoutes: React.FC<{}> = WithErrorHandlers(() => (
...
export default IsAuthenticated(true)(AdminRoutesWrapper);
